---
title: "Skills"
description: "Skills are the foundation of the Pawz extensibility system — part of the 400+ integrations that ship out of the box."
---
...
Pawz ships with **400+ built-in integrations and skills** that are compiled into the binary. These include credential-based vault skills, CLI tools, API integrations, and instruction-based skills across 12 categories.
