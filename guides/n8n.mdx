---
title: "n8n"
description: "OpenPawz embeds n8n as a local automation engine — auto-provisioned, MCP-bridged, with 25,000+ community node types available to your agents."
---

# n8n — Embedded Automation Engine

OpenPawz embeds [n8n](https://n8n.io) directly into the desktop app. It auto-provisions at launch (via Docker or npx), connects via the **Model Context Protocol (MCP)**, and exposes **25,000+ community node types** as agent tools. No manual setup required.
...
### 1. MCP Bridge (Primary — New)

The MCP Bridge connects your agents to n8n's **25,000+ community node types** via the Model Context Protocol. Agents discover and execute n8n nodes automatically:
...
graph LR
    ...
    subgraph n8n Engine
        B -->|"SSE Transport"| C["25,000+ Node Types"]
        C -->|"Auto-install"| D["Community Packages"]
    end
```

See the [MCP Bridge guide](/guides/mcp-bridge) for the full architecture.
