...
sidebar_position: 6
title: "Extensions"
description: Full-power extensions with custom sidebar views, dashboard widgets, persistent storage, and complete API access.
---
...
│                                                     │
│  ┌─────────┐  ┌──────────────────────────────────┐  │
│  │ Sidebar │  │ Extension View (CRM Pipeline)    │  │
│  │         │  │                                  │  │
│  │ Today   │  │  ┌─────┐ ┌─────┐ ┌─────┐       │  │
│  │ Chat    │  │  │ New │→│ Qual│→│Close│       │  │
│  │ Agents  │  │  │  3  │ │  7  │ │  2  │       │  │
...
SKILL.md                    → Tier 1 (Skill)
  ↓ add credentials/TOML
pawz-skill.toml             → Tier 2 (Integration)
  ↓ add [view] + [storage]
pawz-skill.toml + view      → Tier 3 (Extension)
```
