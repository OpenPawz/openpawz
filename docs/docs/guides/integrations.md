...
sidebar_position: 5
title: "Integrations"
description: Connect your agents to third-party APIs and CLI tools with encrypted credentials, binary detection, and dashboard widgets.
---
...
Stored in SQLite (encrypted blob)
       │
       ▼
On prompt build: decrypted in memory
       │
       ▼
Injected into system prompt:
"Credentials: NOTION_API_KEY = secret_abc..."
       │
       ▼
Agent calls fetch with Authorization header
       │
       ▼
Domain allowlist/blocklist enforced
```
