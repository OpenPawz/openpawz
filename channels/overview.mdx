...
<Columns cols={3}>
  ...
  <Card title="Discord" icon="message-circle" href="/channels/discord">
    Gateway WebSocket — community servers
  </Card>
  <Card title="Slack" icon="hash" href="/channels/slack">
    Bot API — workplace teams
  </Card>
  <Card title="Matrix" icon="grid-3x3" href="/channels/matrix">
  ...
  <Card title="Nextcloud" icon="cloud" href="/channels/nextcloud">
    Talk API — Nextcloud users
  </Card>
  <Card title="Nostr" icon="zap" href="/channels/nostr">
    NIP relay protocol — decentralized social
  </Card>
  <Card title="Twitch" icon="tv" href="/channels/twitch">
    IRC + API — live streaming chat
  </Card>
  <Card title="Webchat" icon="globe" href="/channels/webchat">
    HTTP/WebSocket — your own website
  </Card>
  <Card title="WhatsApp" icon="phone" href="/channels/whatsapp">
