...
icon: "sparkles"
description: "Agents are the core of Pawz. Each agent has its own personality, AI model, tools, and conversation history."
---

# Create Your First Agent

Agents are the core of Pawz. Each agent has its own personality, AI model, tools, and conversation history.
...
- [Connect an AI provider](/first-provider) so your agent has a model to use
