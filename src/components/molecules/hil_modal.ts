...
import {
  onEngineToolApproval, resolveEngineToolApproval,
} from '../../engine-bridge';
import type { EngineEvent } from '../../engine';
import {
  classifyCommandRisk, isPrivilegeEscalation, loadSecuritySettings,
  matchesAllowlist, matchesDenylist, auditNetworkRequest,
  getSessionOverrideRemaining, isFilesystemWriteTool,
  activateSessionOverride, extractCommandString,
