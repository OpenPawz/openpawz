...
function tpl(
  ...
  return { id, name, description, category, trigger, steps, requiredServices, tags, estimatedSetup };
}
...
export const TEMPLATE_CATALOG: AutomationTemplate[] = [
  ...
  // ── Slack ────────────────────────────────────────────────────────────
  tpl('slack-daily-digest', 'Daily Channel Digest',
    ...
    ['slack'], ['popular', 'communication'],
  ),

  // ── GitHub ───────────────────────────────────────────────────────────
  tpl('github-issue-to-slack', 'Issue Alert → Slack',
    ...
    ['github', 'slack'], ['popular', 'devops'],
  ),
  tpl('github-pr-review-reminder', 'PR Review Reminder',
  ...
  tpl('github-deploy-notify', 'Deploy Notification',
  ...
  // ── HubSpot ──────────────────────────────────────────────────────────
  tpl('hubspot-deal-alert', 'New Deal Alert',
    ...
    ['hubspot', 'slack'], ['popular', 'sales'],
  ),
  tpl('hubspot-daily-crm-summary', 'Daily CRM Summary',
    ...
    ['hubspot', 'slack'], ['popular', 'sales', 'reporting'],
  ),
  tpl('hubspot-lead-to-trello', 'Lead → Trello Card',
    ...
    ['hubspot', 'trello'], ['sales', 'sync'],
  ),

  // ── Jira ─────────────────────────────────────────────────────────────
  tpl('jira-ticket-to-slack', 'Ticket Alert → Slack',
    ...
    ['jira', 'slack'], ['popular', 'devops'],
  ),
  tpl('jira-sprint-report', 'Sprint Progress Report',
    ...
    ['jira', 'slack'], ['devops', 'reporting'],
  ),

  // ── Stripe ───────────────────────────────────────────────────────────
  tpl('stripe-payment-alert', 'Payment Received Alert',
    ...
    ['stripe', 'slack'], ['popular', 'sales'],
  ),
  tpl('stripe-daily-revenue', 'Daily Revenue Report',
    ...
    ['stripe', 'slack'], ['sales', 'reporting'],
  ),
  tpl('stripe-failed-payment', 'Failed Payment Alert',
  ...
  // ── Trello ───────────────────────────────────────────────────────────
  tpl('trello-stale-card-alert', 'Stale Card Reminder',
    ...
    ['trello', 'slack'], ['productivity'],
  ),
  tpl('trello-card-to-jira', 'Trello Card → Jira Ticket',
    ...
    ['trello', 'jira'], ['sync', 'devops'],
  ),

  // ── Linear ───────────────────────────────────────────────────────────
  tpl('linear-issue-to-slack', 'Linear Issue Alert',
  ...
  // ── Notion ───────────────────────────────────────────────────────────
  tpl('notion-meeting-notes', 'Meeting Notes → Slack',
  ...
  // ── Discord ──────────────────────────────────────────────────────────
  tpl('discord-github-feed', 'GitHub Feed → Discord',
    ...
    ['github', 'discord'], ['devops'],
  ),

  // ── Telegram ─────────────────────────────────────────────────────────
  tpl('telegram-server-alert', 'Server Alert → Telegram',
  ...
  // ── Google Sheets ────────────────────────────────────────────────────
  tpl('sheets-hubspot-sync', 'HubSpot → Google Sheets',
    ...
    ['hubspot', 'google-sheets'], ['sync', 'sales'],
  ),
  tpl('sheets-stripe-log', 'Stripe Payments → Sheets',
    ...
    ['stripe', 'google-sheets'], ['sync', 'sales'],
  ),

  // ── Asana ────────────────────────────────────────────────────────────
  tpl('asana-slack-complete', 'Task Complete → Slack',
  ...
  // ── Monday.com ───────────────────────────────────────────────────────
  tpl('monday-status-slack', 'Status Change → Slack',
    ...
    ['monday', 'slack'], ['productivity'],
  ),

  // ── Shopify ──────────────────────────────────────────────────────────
  tpl('shopify-order-alert', 'New Order Alert',
    ...
    ['shopify', 'slack'], ['popular', 'sales'],
  ),
  tpl('shopify-daily-sales', 'Daily Sales Report',
    ...
    ['shopify', 'slack'], ['sales', 'reporting'],
  ),
  tpl('shopify-low-stock', 'Low Stock Alert',
  ...
  // ── Zendesk ──────────────────────────────────────────────────────────
  tpl('zendesk-urgent-ticket', 'Urgent Ticket Alert',
    ...
    ['zendesk', 'slack'], ['support'],
  ),
  tpl('zendesk-daily-stats', 'Support Stats Report',
    ...
    ['zendesk', 'slack'], ['support', 'reporting'],
  ),

  // ── Salesforce ───────────────────────────────────────────────────────
  tpl('salesforce-deal-won', 'Deal Won → Celebration',
    ...
    ['salesforce', 'slack'], ['popular', 'sales'],
  ),
  tpl('salesforce-weekly-pipeline', 'Weekly Pipeline Report',
    ...
    ['salesforce', 'slack'], ['sales', 'reporting'],
  ),

  // ── Multi-service ────────────────────────────────────────────────────
  tpl('weekly-business-review', 'Weekly Business Review',
    ...
    ['hubspot', 'trello', 'slack'], ['popular', 'reporting'],
  ),
  tpl('customer-onboarding', 'Customer Onboarding Flow',
    ...
    ['hubspot', 'trello', 'slack', 'gmail'], ['onboarding'],
  ),
  tpl('full-stack-deploy', 'Full-Stack Deploy Pipeline',
    ...
    ['github', 'jira', 'slack'], ['devops'],
  ),
  tpl('daily-standup-prep', 'Daily Standup Prep',
    ...
    ['jira', 'slack'], ['popular', 'productivity'],
  ),

  // ── SendGrid ─────────────────────────────────────────────────────────
  tpl('sendgrid-bounce-alert', 'Bounce Alert',
    ...
    ['sendgrid', 'slack'], ['marketing'],
  ),

  // ── Twilio ───────────────────────────────────────────────────────────
  tpl('twilio-missed-call-slack', 'Missed Call → Slack',
  ...
  // ── ClickUp ──────────────────────────────────────────────────────────
  tpl('clickup-weekly-velocity', 'Weekly Velocity Report',
    ...
    ['clickup', 'slack'], ['productivity', 'reporting'],
  ),

  // ── Airtable ─────────────────────────────────────────────────────────
  tpl('airtable-new-record-slack', 'New Record → Slack',
    ...
    ['airtable', 'slack'], ['productivity'],
  ),

  // ── Todoist ──────────────────────────────────────────────────────────
  tpl('todoist-overdue-reminder', 'Overdue Task Reminder',
