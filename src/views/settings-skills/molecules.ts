...
export function setMoleculesState(opts: { currentFilter: string; reloadFn: () => Promise<void> }): void {
...
export function bindFilterEvents(_skills: EngineSkillStatus[], setFilter: (f: string) => void): void {
