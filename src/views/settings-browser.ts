// Settings: Browser & Sandbox — Managed profiles, screenshots, workspaces, network policy
  ...
  try {
    ...
    if (screenshots.length === 0) {
      ...
      for (const ss of screenshots.slice(0, 50)) {
        ...
        // Observe for lazy loading after append
...
async function browseWorkspace(agentId: string, parentSection: HTMLElement) {
  try {
