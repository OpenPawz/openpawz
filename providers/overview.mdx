...
<Columns cols={3}>
  ...
  <Card title="OpenAI" icon="sparkles" href="/providers/openai">
    GPT-4o, o1, o3, o4-mini
  </Card>
  <Card title="Anthropic" icon="shield" href="/providers/anthropic">
    Claude 4 Opus, Sonnet, Haiku
  </Card>
  <Card title="Google" icon="globe" href="/providers/google">
    Gemini 2.5 Pro, Flash
  </Card>
  <Card title="OpenRouter" icon="split" href="/providers/openrouter">
    200+ models via unified API
  </Card>
  <Card title="DeepSeek" icon="search" href="/providers/deepseek">
    DeepSeek V3, R1, Coder
  </Card>
  <Card title="Grok" icon="zap" href="/providers/grok">
    xAI's Grok models
  </Card>
  <Card title="Mistral" icon="wind" href="/providers/mistral">
    Mistral Large, Codestral
  </Card>
  <Card title="Moonshot" icon="moon" href="/providers/moonshot">
    Kimi and Moonshot models
  </Card>
  <Card title="Custom" icon="wrench" href="/providers/custom">
